...
이 문서의 부록 참조할 수 있습니다 사용 하는 방법을 알아보려면 원하는 고 Visual Studio 코드 조각을 사용 하 여 잘 모르는 경우 &quot; [부록 a: 코드 조각을 사용 하 여](#AppendixA)&quot;합니다.
...
10. 애플리케이션을 실행합니다. 이제 갤러리에 사진을 표시 홈 페이지가 나타납니다.
...
8. 애플리케이션을 실행합니다. 주요 내용이 표시 됩니다 있지만 코드 성능 향상 및 더 나은 서버 리소스를 사용 하는 스레드 풀에서 스레드를 차단 하지 않습니다.
...
## <a name="appendix-c-installing-webmatrix-2-and-iphone-simulator"></a>부록 c: WebMatrix 2 및 iPhone 시뮬레이터를 설치합니다.
