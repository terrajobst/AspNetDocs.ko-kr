...
### <a name="exercise-1-adding-a-database"></a>연습 1: 데이터베이스를 추가
...
2. 합니다 **엔터티 데이터 모델 마법사** 나타납니다. 이 마법사는 모델 계층의 생성 안내 합니다. 최근에 추가 된 기존 데이터베이스 기반 모델을 만들 수 해야, 하므로 선택 **데이터베이스에서 생성** 누릅니다 **다음**합니다.
...
이 태스크에서는 코드 중심을 사용 하 여 처음 만들어질 때 샘플 데이터를 사용 하 여 데이터베이스를 채울는 있습니다.
