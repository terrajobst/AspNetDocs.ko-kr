...
이 랩을 완료 하는 시간을 예상 합니다. **30 분**

<a id="Exercise1"></a>

<a id="Exercise_1_Using_ASPNET_MVC_4_Scaffolding_with_Entity_Framework_Migrations"></a>
### <a name="exercise-1-using-aspnet-mvc-4-scaffolding-with-entity-framework-migrations"></a>연습 1: Entity Framework 마이그레이션을 사용 하 여 ASP.NET MVC 4 스 캐 폴딩을 사용
