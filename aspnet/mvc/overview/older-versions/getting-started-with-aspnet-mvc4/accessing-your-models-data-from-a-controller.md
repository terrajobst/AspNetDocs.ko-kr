...
마우스 오른쪽 단추로 클릭 합니다 *컨트롤러* 폴더를 만들어 새 `MoviesController` 컨트롤러입니다. 아래 옵션에는 응용 프로그램을 빌드할 때까지 표시 되지 않습니다. 다음 옵션을 선택합니다.
...
> 
> - 데이터베이스 ' C:\Webs\MVC4\MVCMOVIE\MVCMOVIE\APP\_DATA\MOVIES 합니다. MDF' 706 버전 이므로 열 수 없습니다. 이 서버 버전 655 및 이전 버전을 지원합니다. 다운그레이드는 지원되지 않습니다.
