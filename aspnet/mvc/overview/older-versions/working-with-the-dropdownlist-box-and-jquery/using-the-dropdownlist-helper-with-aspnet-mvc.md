...
드라마 및 적중 선택 목록 변경 합니다 **제출** 단추입니다. 브라우저에서 URL은 `http://localhost:2468/Home/CategoryChosen?MovieType=1` 페이지를 표시 하 고 **선택한: 1**.
...
1. *항목*: [IEnumerable](https://msdn.microsoft.com/library/system.collections.ienumerable.aspx) 목록의 항목을 포함 합니다. 목록 위의 예에서 국가.
