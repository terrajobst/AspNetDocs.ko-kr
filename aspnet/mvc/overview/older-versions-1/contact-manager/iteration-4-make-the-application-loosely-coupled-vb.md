...
---
# <a name="iteration-4--make-the-application-loosely-coupled-vb"></a>반복 #4 – 응용 프로그램을 느슨하게 결합 (VB)
...
**목록 3-Controllerss\omstomomfilev**
...
**목록 4-Models\ubmanagerserviceservice.vb**
