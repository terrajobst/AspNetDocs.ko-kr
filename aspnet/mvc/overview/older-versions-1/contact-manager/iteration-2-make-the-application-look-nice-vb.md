...
---
# <a name="iteration-2--make-the-application-look-nice-vb"></a>반복 #2 – 응용 프로그램을 멋지게 만들기 (VB)
...
이 자습서 시리즈에서는 전체 연락처 관리 응용 프로그램을 처음부터 끝까지 빌드 합니다. 연락처 관리자 응용 프로그램을 사용 하 여 연락처 정보를 저장할 수 있습니다. 이름, 전화 번호 및 전자 메일 주소 – 사용자 목록입니다.
...
- 반복 #3 – 폼 유효성 검사를 추가 합니다. 세 번째 반복에서는 기본 폼 유효성 검사를 추가 합니다. 사용자가 필요한 양식 필드를 완료 하지 않고 양식을 전송 하지 못하도록 합니다. 또한 전자 메일 주소 및 전화 번호의 유효성을 검사 합니다.
...
**그림 01**: ASP.NET MVC 응용 프로그램의 기본 모양 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image2.png))
...
**그림 02**: ASP.NET MVC 디자인 갤러리 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image4.png))
...
**그림 03**: 웹에서 다운로드 한 파일 차단 해제 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image6.png))
...
**그림 04**: 솔루션 탐색기에서 파일 덮어쓰기 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image8.png))
...
**그림 05**: [ProjectName]을 (를) 연락처 관리자로 바꾸기 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image10.png))
...
**그림 06**: 10 월 템플릿 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image12.png))
...
**그림 07**: ASP.NET MVC Contact Manager 디자인 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image14.png))
...
**그림 08**: 선택 및 선택 하지 않은 탭 ([전체 크기 이미지를 보려면 클릭](iteration-2-make-the-application-look-nice-vb/_static/image16.png))
...
**목록 1 – Helpers\MenuItemHelper.vb**
