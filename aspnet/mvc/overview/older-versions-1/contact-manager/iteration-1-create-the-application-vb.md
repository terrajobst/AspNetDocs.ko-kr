...
title: '반복 #1 – 응용 프로그램 만들기 (VB) | Microsoft Docs'
author: microsoft
...
ms.locfileid: "78487571"
---
# <a name="iteration-1--create-the-application-vb"></a>반복 #1 – 응용 프로그램 만들기 (VB)
...
**그림 01**: 새 프로젝트 대화 상자 ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image2.png))
...
**그림 07**: 모델 콘텐츠 선택 ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image14.png))
...
**그림 10**: Contact 클래스 ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image20.png))
...
**그림 13**: 보기 추가 대화 상자 ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image26.png))
...
**그림 15**: 인덱스 뷰 ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image30.png))
...
**목록 4-Controllers\HomeController.vb (Create 메서드 포함)**
...
**그림 16**: Create view 추가 ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image32.png))

**보기 추가** 대화 상자에서 **연락처** 클래스를 선택 하 고 콘텐츠 보기에 대 한 **만들기** 옵션을 선택 합니다 (그림 17 참조). **추가** 단추를 클릭 하면 Create view가 자동으로 생성 됩니다.
...
**그림 17**: 페이지 분해[보기 (전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image34.png))
...
**그림 18**: Create view ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image36.png))
...
**목록 6-Controllers\HomeController.vb (Edit 메서드 포함)**
...
**Controllers\HomeController.vb (Delete 메서드) 목록**
...
**그림 21**: 편집 링크가 있는 인덱스 뷰 ([전체 크기 이미지를 보려면 클릭](iteration-1-create-the-application-vb/_static/image42.png))
...
이 문제는 쉽게 해결할 수 있습니다. 먼저 홈 컨트롤러의 이름을 리팩터링 해야 합니다. Visual Studio Code 편집기에서 HomeController 클래스를 열고 클래스 이름을 마우스 오른쪽 단추로 클릭 한 다음 메뉴 옵션 **이름 바꾸기**를 선택 합니다. 이 메뉴 옵션을 선택 하면 이름 바꾸기 대화 상자가 열립니다.
