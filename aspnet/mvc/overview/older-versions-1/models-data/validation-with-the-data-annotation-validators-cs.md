...
**그림 1**: 데이터 주석 모델 바인더에 대 한 참조를 추가 합니다. ([클릭 하 여 큰 이미지 보기](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
**그림 6**: 유효성 검사기를 사용 하 여 Entity Framework를 사용 하 여 ([클릭 하 여 큰 이미지 보기](validation-with-the-data-annotation-validators-cs/_static/image14.png))
