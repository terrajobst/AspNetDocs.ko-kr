...
ASP.NET MVC 뷰에 데이터베이스 레코드 집합을 표시 해야 하나요? HTML 테이블에 레코드를 표시 하는 두 가지 방법을 알아봅니다. 모든 서식 지정을 인라인으로 수행 하는 방법을 알아봅니다. ASP.NET MVC 사용자 정의 컨트롤을 사용 하 여 템플릿을 만드는 방법도 알아봅니다.

[&#9654;비디오 보기 (15 분)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/displaying-a-table-of-database-data)
