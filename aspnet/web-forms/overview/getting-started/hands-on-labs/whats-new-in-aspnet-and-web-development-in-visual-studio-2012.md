...
2. [연습 2: HTML 편집기에서 새 소식](#Exercise2)
...
6. 기본 클래스 정의 (.main) 찾은 div 요소에 스타일을 추가 합니다. 코드를 한 눈에 부모 클래스를 찾을 수 있도록 사용자가 자동으로 맞춥니다 확인할 수 있습니다.
    ...
    *CSS에서 계층적 맞춤*
7. 내 **.main div** 클래스를 끝에 커서를 찾아 **테두리: 0px;**  키를 누릅니다 **Enter** IntelliSense 목록을 표시 합니다. 입력을 시작 **위쪽** 입력할 때 목록을 필터링 하는 방법을 확인 합니다. 목록에 포함 된 요소가 표시 됩니다 **위쪽** 단어의 모든 부분에서 (Visual Studio의 이전 버전에서는 목록 항목에 의해 필터링 되는 *시작* 용어를 사용 하 여).
...
### <a name="exercise-2-whats-new-in-the-html-editor"></a>연습 2: HTML 편집기에서 새 소식
...
Visual Studio JavaScript 편집기를 액세스할 수 있고 구성 코드 모드에 있도록 프라미스를 갱신 했습니다. 에 이미 존재 하는 여러 Visual Studio 기능 C# 또는 VB 편집기는 이제 JavaScript 편집기에서 구현 됩니다. 정의로 이동, 자동 들여쓰기, 설명서 및 작성 하는 경우 유효성 검사 합니다. 갱신 된 IntelliSense 목록을 사용 하 여 JavaScript 함수 카탈로그 신청 해야 합니다.
