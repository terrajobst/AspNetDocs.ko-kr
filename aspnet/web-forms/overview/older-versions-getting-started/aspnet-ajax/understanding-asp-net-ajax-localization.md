...
## <a name="walkthrough-create-an-localized-embedded-script"></a>연습: 지역화, 포함 된 스크립트를 만들려면
...
1. DeletionResources.resx에 리소스 문자열을 추가 합니다. 
    ...
    **VerifyDelete**: 파일을 삭제 하 시겠습니까 입니까?

    **삭제**: 파일 삭제 되었습니다.

1. DeletionResources.es.resx에 리소스 문자열을 추가 합니다. 

    **VerifyDelete**: 동부 표준시 seguro 쿼리 desee quitar FILENAME?
