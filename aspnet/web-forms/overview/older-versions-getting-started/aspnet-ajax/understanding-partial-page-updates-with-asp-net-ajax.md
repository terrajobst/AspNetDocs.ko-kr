...
| EnableScript-Globalization | Bool | 스크립트 국제화를 사용할지 여부를 나타내는 값을 가져오거나 설정 합니다. |
...
| 스크립트 | Collection&lt;Script-Reference&gt; | 클라이언트에 보낼 스크립트 참조의 컬렉션을 가져옵니다. |
| 서비스 | Collection&lt;Service-Reference&gt; | 클라이언트에 전송 될 웹 서비스 프록시 참조의 컬렉션을 가져옵니다. |
