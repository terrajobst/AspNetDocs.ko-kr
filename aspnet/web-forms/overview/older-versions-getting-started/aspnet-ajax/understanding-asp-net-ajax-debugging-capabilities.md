...
**그림 4**: Web Development Helper ([클릭 하 여 큰 이미지 보기](understanding-asp-net-ajax-debugging-capabilities/_static/image12.png))
...
| traceDump(object, name) | 개체의 데이터를 읽을 수 있는 형식으로 출력합니다. 레이블을 제공 하기 위해 추적 덤프에 대 한 name 매개 변수를 사용할 수 있습니다. 모든 하위 개체 덤프 되는 개체 내에서 기본적으로 작성 됩니다. |
