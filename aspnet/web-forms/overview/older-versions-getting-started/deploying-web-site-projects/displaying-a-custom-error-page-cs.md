...
**그림 1**: 예외 세부 정보 YSOD 예외 정보를 포함 합니다.  
...
**그림 6**: ASP.NET 런타임 응답을 표시 구성 오류 페이지에 잘못 된 요청 ([클릭 하 여 큰 이미지 보기](displaying-a-custom-error-page-cs/_static/image17.png))
