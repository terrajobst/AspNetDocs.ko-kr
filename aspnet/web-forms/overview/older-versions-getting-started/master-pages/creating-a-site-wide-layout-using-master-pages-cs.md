...
[![T일관성 확인 및 모든 페이지에서 느낌을 이용 하는 그 www.asp.net 웹 사이트](creating-a-site-wide-layout-using-master-pages-cs/_static/image2.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image1.png)
...
[![T마스터 페이지에는 그 요청한 페이지의 태그를 결합 하](creating-a-site-wide-layout-using-master-pages-cs/_static/image6.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image5.png)
...
[![CNew File System-Based 웹 사이트를 reate](creating-a-site-wide-layout-using-master-pages-cs/_static/image9.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image8.png)
...
[![Add는 마스터 페이지 라는 Site.master 웹 사이트](creating-a-site-wide-layout-using-master-pages-cs/_static/image12.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image11.png)
...
[![T위쪽, 왼쪽 및 아래쪽 부분에 대 한 태그를 정의 그 마스터 페이지](creating-a-site-wide-layout-using-master-pages-cs/_static/image15.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image14.png)
...
[![Add 새 콘텐츠 페이지](creating-a-site-wide-layout-using-master-pages-cs/_static/image18.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image17.png)

**그림 07**: 새 콘텐츠 페이지 추가 ([클릭 하 여 큰 이미지 보기](creating-a-site-wide-layout-using-master-pages-cs/_static/image19.png))


[![SSite.master 마스터 페이지 선택](creating-a-site-wide-layout-using-master-pages-cs/_static/image21.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image20.png)
...
[![T그 콘텐츠 페이지의 디자인 뷰가 표시 페이지-특정과 마스터 페이지 콘텐츠](creating-a-site-wide-layout-using-master-pages-cs/_static/image24.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image23.png)
...
[![Visit about.aspx로 페이지를 통해는 브라우저](creating-a-site-wide-layout-using-master-pages-cs/_static/image27.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image26.png)
...
[![T마스터 페이지에 변경 내용을 볼 때 반영 되는 콘텐츠 페이지](creating-a-site-wide-layout-using-master-pages-cs/_static/image30.png)](creating-a-site-wide-layout-using-master-pages-cs/_static/image29.png)
