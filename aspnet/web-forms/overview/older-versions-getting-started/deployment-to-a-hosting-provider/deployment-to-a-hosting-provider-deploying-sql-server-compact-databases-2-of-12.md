...
title: SQL Server Compact Visual Studio 또는 Visual Web Developer를 사용 하 여를 사용 하 여 ASP.NET 웹 응용 프로그램을 배포 합니다. SQL Server Compact 데이터베이스-2/12 배포 합니다. | Microsoft Docs
author: tdykstra
...
애플리케이션을 실행합니다. 이제 학생 페이지가 비어 있지만 강사 페이지는 강사를 포함 합니다. 새로운 하면 프로덕션 환경에서 응용 프로그램을 배포한 후입니다.
