...
편집 하는 방법에 대 한 자세한 합니다 `PreSource` 프로젝트 파일에서 요소 참조 [방법: 프로젝트 파일에서 배포 설정을 편집](https://msdn.microsoft.com/library/ff398069(v=vs.100).aspx)합니다. 사용자 또는 역할을 개발 데이터베이스에서 대상 데이터베이스에 필요한 경우 지원에 대 한 호스팅 공급자에 게 문의 합니다.
...
배포 하려는 경우 다음 오류 메시지가 표시:
 ...
 오류: 스트림 데이터를 ' sitemanifest/dbFullSql [@path= 'C:\TEMP\AdventureWorksGrant.sql']/sqlScript'를 사용할 수 없습니다. 사용 하려는 응용 프로그램 풀 'managedRuntimeVersion' 속성이 ('v2.0'로 설정 되어 있습니다. 이 응용 프로그램 'v4.0' 필요합니다. 
