...
[![F새 페이지에 추가 된 멤버 자격 폴더 ive](creating-user-accounts-vb/_static/image2.png)](creating-user-accounts-vb/_static/image1.png)

**그림 1**: 5 개의 새 페이지에 추가한 합니다 `Membership` 폴더 ([큰 이미지를 보려면 클릭](creating-user-accounts-vb/_static/image3.png))
...
[![A프로젝트의 루트 디렉터리에 파일 이름이 Web.sitemap dd](creating-user-accounts-vb/_static/image5.png)](creating-user-accounts-vb/_static/image4.png)

**그림 2**: 라는 파일을 추가 `Web.sitemap` 프로젝트의 루트 디렉터리 ([큰 이미지를 보려면 클릭](creating-user-accounts-vb/_static/image6.png))
...
[![T그 사이트 맵 탐색 계층 구조를 나타내는](creating-user-accounts-vb/_static/image8.png)](creating-user-accounts-vb/_static/image7.png)

**그림 3**: 사이트 맵 탐색 계층 구조를 나타냅니다 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image9.png))


## <a name="step-3-updating-the-master-page-to-include-a-navigational-user-interface"></a>3단계: 탐색 사용자 인터페이스를 포함 하도록 마스터 페이지를 업데이트 하는 중
...
이 인터페이스를 만들려면 다음 선언적 태그를 추가 합니다 `Site.master` 마스터 페이지의 왼쪽 열 여기서 TODO 텍스트: 메뉴를 여기로 이동 하는 중... 현재 상주합니다.
...
[![T그 탐색 사용자 인터페이스는 렌더링 된 목록을 사용 하 여 중첩 된 순서가 지정 되지 않은](creating-user-accounts-vb/_static/image11.png)](creating-user-accounts-vb/_static/image10.png)

**그림 4**: 탐색 사용자 인터페이스는 렌더링 된 목록을 사용 하 여 중첩 된 순서가 지정 되지 않은 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image12.png))
...
[![T이동 경로 탐색 그 현재 페이지와 해당 상위 사이트 맵에 표시](creating-user-accounts-vb/_static/image14.png)](creating-user-accounts-vb/_static/image13.png)

**그림 5**: 사이트 맵에 있는 현재 페이지와 해당 상위 요소를 표시 하는 이동 경로 탐색 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image15.png))


## <a name="step-4-removing-the-custom-principal-and-identity-logic"></a>4단계: 사용자 지정 보안 주체와 Id 논리를 제거합니다.
...
[![Add CreatingUserAccounts.aspx 페이지에 다양 한 웹 컨트롤](creating-user-accounts-vb/_static/image17.png)](creating-user-accounts-vb/_static/image16.png)

**그림 6**: 다양 한 웹 컨트롤을 추가 합니다 `CreatingUserAccounts.aspx Page` ([큰 이미지를 보려면 클릭](creating-user-accounts-vb/_static/image18.png))


`SecurityQuestion` 레이블 및 `SecurityAnswer` 텍스트 상자는 미리 정의 된 보안 질문을 표시 하 고 사용자의 답변을 수집 하려고 합니다. 참고는 보안 질문 및 답변에 모두 저장 되므로 사용자 간 별로 각 사용자가 자신의 보안 질문을 정의 하도록 허용 하는 것이 가능 합니다. 그러나이 예제에 대 한 하기로 즉 유니버설 보안 질문을 사용 하 여: 원하는 색 이란?
...
[![A 새 사용자 계정을 만들었습니다.입니다.](creating-user-accounts-vb/_static/image20.png)](creating-user-accounts-vb/_static/image19.png)

**그림 7**: 새 사용자 계정을 성공적으로 생성 됩니다 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image21.png))


[![T제공 된 암호가 너무 약 때문에 그 사용자 계정 생성 되지 않습니다](creating-user-accounts-vb/_static/image23.png)](creating-user-accounts-vb/_static/image22.png)

**그림 8**: 제공 된 암호가 너무 약 때문에 사용자 계정이 만들어집니다 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image24.png))


[![T사용자 이름이 이미 사용에서 중 이므로 그 사용자 계정 생성 되지 않습니다](creating-user-accounts-vb/_static/image26.png)](creating-user-accounts-vb/_static/image25.png)

**그림 9**: 사용자 계정이 생성 때문이 아니라 사용자가 이미 사용에서 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image27.png))
...
[![T멤버 자격 사용자 저장소에 두 명의 사용자가 다음과 같습니다. Tito 및 Bruce](creating-user-accounts-vb/_static/image29.png)](creating-user-accounts-vb/_static/image28.png)

**그림 10**: 멤버 자격 사용자 저장소에 두 사용자를 가지 있습니다. Tito 및 Bruce ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image30.png))
...
[![T그 CreateUserWizard 컨트롤 렌더링을 일반 사용자 인터페이스 만들기](creating-user-accounts-vb/_static/image32.png)](creating-user-accounts-vb/_static/image31.png)

**그림 11**: CreateUserWizard 컨트롤 렌더링을 일반 사용자 인터페이스 만들기 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image33.png))
...
[![T그 CreateUserWizard 자동으로 삽입 유효성 검사 컨트롤](creating-user-accounts-vb/_static/image35.png)](creating-user-accounts-vb/_static/image34.png)

**그림 12**: CreateUserWizard 자동으로 삽입 유효성 검사 컨트롤 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image36.png))
...
[![A 새 사용자 계정에 성공적으로 만들어진](creating-user-accounts-vb/_static/image38.png)](creating-user-accounts-vb/_static/image37.png)

**그림 13**: 새 사용자 계정에 성공적으로 생성 된 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image39.png))
...
[![T취소 단추가 포함 그 CreateUserWizardStep](creating-user-accounts-vb/_static/image41.png)](creating-user-accounts-vb/_static/image40.png)

**그림 14**: 합니다 `CreateUserWizardStep` 취소 단추가 포함 됩니다 ([큰 이미지를 보려면 클릭](creating-user-accounts-vb/_static/image42.png))
...
[![U선행 또는 후행 공백 사용 하 여 sernames 허용 되지 않는](creating-user-accounts-vb/_static/image44.png)](creating-user-accounts-vb/_static/image43.png)

**그림 15**: 사용자 이름은 선행 또는 후행 공백이 허용 되지 않습니다 ([클릭 하 여 큰 이미지 보기](creating-user-accounts-vb/_static/image45.png))
