...
[![T폼 인증 그 URL 권한 부여 워크플로](user-based-authorization-cs/_static/image2.png)](user-based-authorization-cs/_static/image1.png)
...
[![T그 기본 워크플로 혼동 사이클에 발생할 수 있습니다](user-based-authorization-cs/_static/image5.png)](user-based-authorization-cs/_static/image4.png)
...
[![Add는 Web.config 파일을 멤버 자격 폴더](user-based-authorization-cs/_static/image8.png)](user-based-authorization-cs/_static/image7.png)
...
[![Y이제 응용 프로그램 Web.config 파일을 두 개의 포함](user-based-authorization-cs/_static/image11.png)](user-based-authorization-cs/_static/image10.png)
...
[![SURL 권한 부여 규칙 금지 익명 액세스를 ince 로그인 페이지로 리디렉션됩니다에서는](user-based-authorization-cs/_static/image14.png)](user-based-authorization-cs/_static/image13.png)
...
[![Authenticated, 권한이 없는 사용자가 UnauthorizedAccess.aspx가 리디렉션됩니다](user-based-authorization-cs/_static/image17.png)](user-based-authorization-cs/_static/image16.png)
...
[![T웹 응용 프로그램의 루트 디렉터리의 파일을 나열 그 GridView](user-based-authorization-cs/_static/image20.png)](user-based-authorization-cs/_static/image19.png)
...
[![T그리고 선택한 파일의 내용은 텍스트 상자에 표시 됩니다](user-based-authorization-cs/_static/image23.png)](user-based-authorization-cs/_static/image22.png)
...
[![C클릭 하 여 삭제 단추 실제로 삭제 되지 않습니다 파일](user-based-authorization-cs/_static/image26.png)](user-based-authorization-cs/_static/image25.png)
...
[![T그 LoginView 컨트롤 Authenticated Users FileContents 텍스트만 렌더링](user-based-authorization-cs/_static/image29.png)](user-based-authorization-cs/_static/image28.png)
...
[![T익명의 방문자에 대 한 보기 Linkbutton을 숨깁니다 그 LoginView 컨트롤](user-based-authorization-cs/_static/image32.png)](user-based-authorization-cs/_static/image31.png)
...
[![T열 삭제 담당 하지 렌더링 경우 방문 하 여 사용자가 아닌 다른 Tito (예: Bruce)](user-based-authorization-cs/_static/image35.png)](user-based-authorization-cs/_static/image34.png)

**그림 12**: 삭제할 열이 없습니다 렌더링 경우 방문 하 여 누군가가 이외의 Tito (예: Bruce) ([클릭 하 여 큰 이미지 보기](user-based-authorization-cs/_static/image36.png))


[![T그 열 삭제는 Tito 렌더링](user-based-authorization-cs/_static/image38.png)](user-based-authorization-cs/_static/image37.png)
...
[![I보안 컨텍스트는 메서드를 실행할 수 없는 권한이 없습니다 f SecurityException이 Throw](user-based-authorization-cs/_static/image41.png)](user-based-authorization-cs/_static/image40.png)
