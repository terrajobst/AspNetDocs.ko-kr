...
[![F역할 폴더에 추가 된 새 우리가](creating-and-managing-roles-cs/_static/image2.png)](creating-and-managing-roles-cs/_static/image1.png)

**그림 1**: 4 개의 새 페이지에 추가한 합니다 `Roles` 폴더 ([큰 이미지를 보려면 클릭](creating-and-managing-roles-cs/_static/image3.png))
...
[![F역할 폴더에 추가 된 새 우리가](creating-and-managing-roles-cs/_static/image5.png)](creating-and-managing-roles-cs/_static/image4.png)

**그림 2**: 4 개의 새 페이지에 추가한 합니다 `Roles` 폴더 ([큰 이미지를 보려면 클릭](creating-and-managing-roles-cs/_static/image6.png))
...
[![C관리자 역할을 reate](creating-and-managing-roles-cs/_static/image8.png)](creating-and-managing-roles-cs/_static/image7.png)

**그림 3**: 관리자 역할을 만들고 ([클릭 하 여 큰 이미지 보기](creating-and-managing-roles-cs/_static/image9.png))
...
[![T관리자에 대 한 행이 있는 그 aspnet_Roles 테이블](creating-and-managing-roles-cs/_static/image11.png)](creating-and-managing-roles-cs/_static/image10.png)

**그림 4**: 합니다 `aspnet_Roles` 테이블에는 관리자에 대 한 행이 있습니다 ([큰 이미지를 보려면 클릭](creating-and-managing-roles-cs/_static/image12.png))
...
[![T단일 열에서 역할을 표시 하는 GridView 그](creating-and-managing-roles-cs/_static/image14.png)](creating-and-managing-roles-cs/_static/image13.png)

**그림 5**: 단일 열에는 역할을 표시 하는 GridView ([클릭 하 여 큰 이미지 보기](creating-and-managing-roles-cs/_static/image15.png))
...
[![T그 감독자 역할에 추가한](creating-and-managing-roles-cs/_static/image17.png)](creating-and-managing-roles-cs/_static/image16.png)

**그림 6**: 감독자 역할에 추가 되었습니다 ([클릭 하 여 큰 이미지 보기](creating-and-managing-roles-cs/_static/image18.png))
...
[![Add RoleList GridView에 삭제 단추](creating-and-managing-roles-cs/_static/image20.png)](creating-and-managing-roles-cs/_static/image19.png)

**그림 7**: 삭제 단추를 추가 합니다 `RoleList` GridView ([큰 이미지를 보려면 클릭](creating-and-managing-roles-cs/_static/image21.png))
