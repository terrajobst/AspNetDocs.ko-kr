...
**그림 5**: FTP 위치 대화 상자를 선택 합니다.

## <a name="lab-setup-ftp-site-and-create-a-project"></a>랩: FTP 사이트를 설치 하 고 프로젝트 만들기
...
7. **열기**를 클릭합니다. FTP 위치는 새 웹 사이트 대화 상자에 입력 됩니다.
8. **확인**을 클릭합니다.
...
웹 프로젝트를 열려면 파일 메뉴에서 웹 사이트 열기를 선택 합니다. 이전에 적용 하 여 동일한 위치 선택 대화 상자를 사용 하 여 묻는 메시지가 나타납니다 있고 같은 네 가지 옵션을 사용할 수 있습니다. 파일 시스템, 로컬 IIS, FTP 및 원격 사이트를 선택 합니다.
...
**그림 12**: Windows 방화벽이 원격 디버깅 차단 하는 알림
