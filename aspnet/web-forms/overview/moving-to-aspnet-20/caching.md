...
- 작업자 프로세스 전용 바이트 제한이 설정 되어 있지 않으면 캐시는 다음과 같은 제한이 중 하나를 사용 됩니다. 
    ...
    - x86 2GB: 800 MB 또는 실제 RAM의 60% 더 작은
    - x86 3GB: 1800 MB 또는 실제 RAM의 60% 더 작은
    - x64: 1 테라바이트 또는 실제 RAM의 60% 더 작은
...
7. Showdata.aspx 새 SqlDataSource 컨트롤을 추가 하 고 Northwind 데이터베이스 연결을 사용 하도록 구성 합니다. 다음을 클릭합니다.
