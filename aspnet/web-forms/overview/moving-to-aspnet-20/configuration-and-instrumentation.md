...
| [System.Management.Instrumentation](https://msdn.microsoft.com/library/system.management.instrumentation.aspx) namespace | 해당 관리 정보 및 잠재 고객에 게 Windows Management Instrumentation (WMI)를 통해 이벤트를 노출 하는 응용 프로그램의 계측을 위해 필요한 클래스를 제공 합니다. ASP.NET 상태 모니터링 이벤트를 제공 하도록 WMI를 사용 합니다. 엄격히 말해,이 네임 스페이스는 구성 API의 일부로 간주 되지 않습니다. |
...
## <a name="lab-1-using-the-configuration-api"></a>1 랩: 구성 API를 사용 하 여
