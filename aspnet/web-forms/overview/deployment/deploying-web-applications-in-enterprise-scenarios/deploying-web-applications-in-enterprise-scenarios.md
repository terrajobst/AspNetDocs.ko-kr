...
이 자습서 집합 참조 구현을 제공 하 고 작업 및 연습 일반적인 컨텍스트를 제공 하기 현실적인 수준의 복잡성을 가상의 엔터프라이즈 배포 시나리오와 함께 샘플 솔루션을 사용 합니다. 다음 항목에서는 [엔터프라이즈 웹 배포: 시나리오 개요](enterprise-web-deployment-scenario-overview.md), 시나리오 및 샘플 솔루션을 소개 합니다. 여기에서 자습서 및 요구 사항을 가장 잘 일치 하는 항목을 통해 사용할 수 있습니다.
