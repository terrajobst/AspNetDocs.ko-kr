...
[![S명함을 만들기 위한 단순 양식](using-the-colorpicker-control-extender-vb/_static/image1.jpg)](using-the-colorpicker-control-extender-vb/_static/image1.png)
...
[![T그 ColorPicker Control Extender](using-the-colorpicker-control-extender-vb/_static/image2.jpg)](using-the-colorpicker-control-extender-vb/_static/image3.png)
...
[![Aextender 이어지지](using-the-colorpicker-control-extender-vb/_static/image3.jpg)](using-the-colorpicker-control-extender-vb/_static/image5.png)

**그림 03**: Extender 추가 ([클릭 하 여 큰 이미지 보기](using-the-colorpicker-control-extender-vb/_static/image6.png))


[![SExtender 마법사를 사용 하 여 컨트롤 extender는 선택](using-the-colorpicker-control-extender-vb/_static/image4.jpg)](using-the-colorpicker-control-extender-vb/_static/image7.png)
...
[![D색 선택 대화 상자 단추를 사용 하 여 isplaying](using-the-colorpicker-control-extender-vb/_static/image5.jpg)](using-the-colorpicker-control-extender-vb/_static/image9.png)
