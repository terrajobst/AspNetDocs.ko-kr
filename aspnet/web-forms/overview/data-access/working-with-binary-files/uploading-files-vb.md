...
[![Add Default.aspx SectionLevelTutorialListing.ascx 사용자 정의 컨트롤](uploading-files-vb/_static/image2.gif)](uploading-files-vb/_static/image1.png)
...
[![B파일 시스템 또는 데이터베이스에서 직접 데이터를 저장할 수 있습니다 포인트](uploading-files-vb/_static/image4.gif)](uploading-files-vb/_static/image3.png)

**그림 4**: 파일 시스템 또는 데이터베이스에서 직접 이진 데이터를 저장할 수 있습니다 ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image4.png))
...
## <a name="step-3-adding-thebrochurepathcolumn-to-thecategoriestable"></a>3단계: 추가 된`BrochurePath`열에는`Categories`테이블
...
[![Add Categories 테이블 BrochurePath 열](uploading-files-vb/_static/image5.gif)](uploading-files-vb/_static/image5.png)
...
[![C데이터 형식을 갖는 System.Byte []]는 DataColumn 라는 그림 작성(uploading-files-vb/_static/image6.gif)](uploading-files-vb/_static/image7.png)

**그림 6**: 만들기는 `DataColumn` 명명 된 `Picture` 인 `DataType` 됩니다 `System.Byte[]` ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image8.png))
...
[![U또한 반환 BrochurePath를 SELECT 문에 열 목록을 업데이트 ()](uploading-files-vb/_static/image7.gif)](uploading-files-vb/_static/image9.png)

**그림 7**: 열 목록을 업데이트 합니다 `SELECT` 문 또한 반환할 `BrochurePath` ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image10.png))
...
[![S사용 하 여 SQL 문을 옵션 선택](uploading-files-vb/_static/image8.gif)](uploading-files-vb/_static/image11.png)

**그림 8**: 사용 하 여 SQL 문을 옵션을 선택 ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image12.png))


[![Since 쿼리 범주 테이블의 행을 반환 하는 선택 선택 된 레코드를 반환 합니다](uploading-files-vb/_static/image9.gif)](uploading-files-vb/_static/image13.png)

**그림 9**: 쿼리는 행을 반환 하는 선택 선택 범주 테이블에서 레코드를 반환 하므로 ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image14.png))
...
[![C설치할의 메서드 이름](uploading-files-vb/_static/image10.gif)](uploading-files-vb/_static/image15.png)

**그림 10**: Tableadapter 메서드 이름 선택 ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image16.png))
...
## <a name="step-5-uploading-a-file-from-the-client-to-the-web-server"></a>5단계: 웹 서버에 클라이언트에서 파일 업로드
...
[![Add는 FileUpload 컨트롤을 ASP.NET 페이지](uploading-files-vb/_static/image12.gif)](uploading-files-vb/_static/image17.png)

**그림 12**: FileUpload 컨트롤을 ASP.NET 페이지 추가 ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image18.png))
...
[![T서버에 해당 컴퓨터에서 업로드할 파일을 선택할 수 그 사용자](uploading-files-vb/_static/image13.gif)](uploading-files-vb/_static/image19.png)

**그림 13**: 사용자가 컴퓨터를 서버에서 업로드할 파일을 선택할 수 ([클릭 하 여 큰 이미지 보기](uploading-files-vb/_static/image20.png))
...
[![T그 파일 EvolutionValley.jpg에 업로드 된 웹 서버](uploading-files-vb/_static/image14.gif)](uploading-files-vb/_static/image21.png)

**그림 14**: 파일 `EvolutionValley.jpg` 웹 서버에 업로드 된 ([큰 이미지를 보려면 클릭](uploading-files-vb/_static/image22.png))
