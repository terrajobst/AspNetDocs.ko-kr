...
## <a name="step-1-replicating-the-example-fromhandling-bll--and-dal-level-exceptionshandling-bll-and-dal-level-exceptions-csmd"></a>1단계: 예제를 복제[BLL 및 DAL 수준의 예외 처리](handling-bll-and-dal-level-exceptions-cs.md)
