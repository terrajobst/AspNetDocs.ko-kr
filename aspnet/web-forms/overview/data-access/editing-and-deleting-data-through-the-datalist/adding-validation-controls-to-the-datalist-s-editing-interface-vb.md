...
## <a name="step-1-replicating-the-example-fromhandling-bll--and-dal-level-exceptions"></a>1 단계:[BLL 및 DAL 수준의 예외 처리](handling-bll-and-dal-level-exceptions-vb.md) 에서 예제 복제
