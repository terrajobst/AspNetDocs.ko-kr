...
description: 이 자습서 집합에서는 사이트 성능을 향상 시킬 수 있는 캐싱과 ObjectDataSource 컨트롤을 사용 하 여 프레젠테이션 계층에 캐싱을 적용 하는 방법을 설명 합니다.
ms.author: riande
ms.date: 10/05/2011
...
ms.locfileid: "78465629"
---
# <a name="caching-data"></a>데이터 캐싱

> 이 자습서 집합에서는 사이트 성능을 향상 시킬 수 있는 캐싱과 ObjectDataSource 컨트롤을 사용 하 여 프레젠테이션 계층에 캐싱을 적용 하는 방법을 설명 합니다.
