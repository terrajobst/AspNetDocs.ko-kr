...
[샘플 앱 다운로드](https://download.microsoft.com/download/9/c/1/9c1d03ee-29ba-4d58-aa1a-f201dcc822ea/ASPNET_Data_Tutorial_24_VB.exe) 또는 [PDF 다운로드](paging-and-sorting-report-data-vb/_static/datatutorial24vb1.pdf)
...
[각 제품이 나열 ![](paging-and-sorting-report-data-vb/_static/image7.png)](paging-and-sorting-report-data-vb/_static/image6.png)

**그림 6**: 각 제품이 나열 됩니다 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image8.png)).
...
[페이징 지원을 추가 하려면 페이징 사용 확인란을 선택 ![.](paging-and-sorting-report-data-vb/_static/image10.png)](paging-and-sorting-report-data-vb/_static/image9.png)

**그림 7**: 페이징 사용 확인란을 선택 하 여 페이징 지원 추가 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image11.png))
...
[페이징을 사용 하는 ![레코드의 하위 집합만 한 번에 표시 됩니다.](paging-and-sorting-report-data-vb/_static/image13.png)](paging-and-sorting-report-data-vb/_static/image12.png)

**그림 8**: 페이징을 사용 하도록 설정 하면 레코드의 하위 집합만 한 번에 표시 됩니다 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image14.png)).
...
[페이지 번호를 클릭 하면 포스트백이 발생 하 고 레코드의 적절 한 하위 집합이 표시 됩니다. ![](paging-and-sorting-report-data-vb/_static/image16.png)](paging-and-sorting-report-data-vb/_static/image15.png)

**그림 9**: 페이지 번호를 클릭 하면 포스트백이 발생 하 고 레코드의 적절 한 하위 집합이 표시 됩니다 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image17.png)).
...
[현재 페이지 번호와 총 페이지 수를 표시 ![](paging-and-sorting-report-data-vb/_static/image19.png)](paging-and-sorting-report-data-vb/_static/image18.png)

**그림 10**: 현재 페이지 번호와 총 페이지 수 표시 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image20.png))
...
[페이지 6 드롭다운 목록 항목을 선택할 때 사용자가 여섯 번째 페이지로 자동으로 이동 ![](paging-and-sorting-report-data-vb/_static/image22.png)](paging-and-sorting-report-data-vb/_static/image21.png)

**그림 11**: 페이지 6 드롭다운 목록 항목을 선택할 때 사용자가 여섯 번째 페이지로 자동 이동 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image23.png))
...
[단가를 기준으로 결과를 오름차순으로 정렬 ![](paging-and-sorting-report-data-vb/_static/image25.png)](paging-and-sorting-report-data-vb/_static/image24.png)

**그림 12**: 단가를 기준으로 결과가 오름차순으로 정렬 됨 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image26.png))
...
[SortExpression 속성을 제거 하면 사용자가 더 이상 가격으로 제품을 정렬할 수 없습니다. ![](paging-and-sorting-report-data-vb/_static/image29.png)](paging-and-sorting-report-data-vb/_static/image28.png)

**그림 14**: SortExpression 속성을 제거 하 여 사용자가 더 이상 제품을 가격 기준으로 정렬할 수 없음 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image30.png))
...
[단추를 클릭 하면 가장 비용이 많이 드는 것부터 가장 비싼 순서로 제품을 ![](paging-and-sorting-report-data-vb/_static/image32.png)](paging-and-sorting-report-data-vb/_static/image31.png)

**그림 15**: 단추를 클릭 하면 비용이 가장 많이 드는 것부터 최소까지 ([전체 크기 이미지를 보려면 클릭](paging-and-sorting-report-data-vb/_static/image33.png))
