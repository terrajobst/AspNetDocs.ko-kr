...
**그림 2**: 출력 창에 저장 프로시저 결과가 표시 됩니다 ([전체 크기 이미지를 보려면 클릭](sorting-custom-paged-data-vb/_static/image4.png)).
...
**그림 10**: 이제 공급자를 기준으로 결과를 정렬할 수 있습니다 ([전체 크기 이미지를 보려면 클릭](sorting-custom-paged-data-vb/_static/image16.png)).
