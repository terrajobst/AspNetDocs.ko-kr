...
## <a name="step-1-displaying-the-categories-in-a-bulleted-list"></a>1단계: 글머리 기호 목록에서 범주를 표시합니다.
...
[![Configure CategoriesBLL 클래스의 GetCategories 메서드를 사용 하는 ObjectDataSource](master-detail-filtering-acess-two-pages-datalist-cs/_static/image2.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image1.png)
...
[![E범주 글머리 기호 목록 항목으로 표시 됩니다 대 한 ach](master-detail-filtering-acess-two-pages-datalist-cs/_static/image5.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image4.png)
...
[![T그 범주 이름은 이제 연결할 ProductsForCategoryDetails.aspx](master-detail-filtering-acess-two-pages-datalist-cs/_static/image8.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image7.png)
...
[![Configure ProductsBLL 클래스의 GetProductsByCategoryID(categoryID) 메서드를 사용 하는 ObjectDataSource](master-detail-filtering-acess-two-pages-datalist-cs/_static/image11.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image10.png)
...
[![U매개 변수의 원본으로 쿼리 문자열 필드 CategoryID se](master-detail-filtering-acess-two-pages-datalist-cs/_static/image14.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image13.png)
...
[![T그 음료 표시 되는 행 마다 2](master-detail-filtering-acess-two-pages-datalist-cs/_static/image17.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image16.png)
...
[![A액세스 CategoriesBLL 클래스의 GetCategoryByCategoryID(categoryID) 메서드를 통해 범주에 대 한 정보](master-detail-filtering-acess-two-pages-datalist-cs/_static/image20.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image19.png)
...
[![Category 정보 페이지의 맨 위에 있는 표시입니다.](master-detail-filtering-acess-two-pages-datalist-cs/_static/image23.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image22.png)
...
[![A 선택한 범주에 없는 제품 속하는 경우 메시지가 표시 됩니다](master-detail-filtering-acess-two-pages-datalist-cs/_static/image26.png)](master-detail-filtering-acess-two-pages-datalist-cs/_static/image25.png)
