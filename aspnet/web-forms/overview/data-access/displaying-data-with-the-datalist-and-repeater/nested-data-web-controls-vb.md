...
[![E해당 제품을 함께 범주에 대 한 ach 나와](nested-data-web-controls-vb/_static/image2.png)](nested-data-web-controls-vb/_static/image1.png)
...
[![N새 ObjectDataSource CategoriesDataSource \ 이름](nested-data-web-controls-vb/_static/image5.png)](nested-data-web-controls-vb/_static/image4.png)
...
[![Configure CategoriesBLL 클래스의 GetCategories 메서드를 사용 하는 ObjectDataSource](nested-data-web-controls-vb/_static/image8.png)](nested-data-web-controls-vb/_static/image7.png)
...
[![E범주 이름이 대 한 ach 및 설명을 나열 수평선 구분 됩니다](nested-data-web-controls-vb/_static/image11.png)](nested-data-web-controls-vb/_static/image10.png)
...
## <a name="step-3-binding-the-category-specific-products-to-the-productsbycategorylist-repeater"></a>3단계: 범주별 제품 ProductsByCategoryList Repeater에 바인딩
...
[![T외부 Repeater 목록을 범주별; 해당 범주에 대 한 제품을 나열 하는 내부](nested-data-web-controls-vb/_static/image14.png)](nested-data-web-controls-vb/_static/image13.png)
