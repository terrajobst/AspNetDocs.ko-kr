...
[![Two TemplateFields는 표시를 사용자 지정 하는 데 사용 됩니다](using-templatefields-in-the-detailsview-control-cs/_static/image2.png)](using-templatefields-in-the-detailsview-control-cs/_static/image1.png)
...
[![Add GetProducts() 메서드를 호출 하는 새 ObjectDataSource 컨트롤](using-templatefields-in-the-detailsview-control-cs/_static/image5.png)](using-templatefields-in-the-detailsview-control-cs/_static/image4.png)
...
[![T제품의 세부 정보가 BoundFields 시리즈를 사용 하 여 표시 됩니다](using-templatefields-in-the-detailsview-control-cs/_static/image8.png)](using-templatefields-in-the-detailsview-control-cs/_static/image7.png)
...
[![ADetailsView 컨트롤에 새 TemplateField dd](using-templatefields-in-the-detailsview-control-cs/_static/image11.png)](using-templatefields-in-the-detailsview-control-cs/_static/image10.png)
...
[![B레이블의 텍스트 속성을 UnitPrice 데이터 필드를 찾기](using-templatefields-in-the-detailsview-control-cs/_static/image14.png)](using-templatefields-in-the-detailsview-control-cs/_static/image13.png)
...
[![T가격은 그 인벤토리 TemplateField 가격 표시](using-templatefields-in-the-detailsview-control-cs/_static/image17.png)](using-templatefields-in-the-detailsview-control-cs/_static/image16.png)
...
[![Format 통화로 가격](using-templatefields-in-the-detailsview-control-cs/_static/image20.png)](using-templatefields-in-the-detailsview-control-cs/_static/image19.png)
...
[![T그 가격 및 인벤토리 정보는 단일 행에 표시 됩니다](using-templatefields-in-the-detailsview-control-cs/_static/image23.png)](using-templatefields-in-the-detailsview-control-cs/_static/image22.png)
...
[![T그 문자열 True 및 False는 지원 되지 않는 상태를 표시 하는 데 사용](using-templatefields-in-the-detailsview-control-cs/_static/image26.png)](using-templatefields-in-the-detailsview-control-cs/_static/image25.png)
...
[![YES 또는 아니요 값 이제 지원 되지 않는 행에 표시 된](using-templatefields-in-the-detailsview-control-cs/_static/image29.png)](using-templatefields-in-the-detailsview-control-cs/_static/image28.png)
