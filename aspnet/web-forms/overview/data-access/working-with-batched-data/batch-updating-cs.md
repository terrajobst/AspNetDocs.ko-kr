...
[![E대 한 ach GridView의 행은 편집 가능](batch-updating-cs/_static/image1.gif)](batch-updating-cs/_static/image1.png)
...
[![Configure ProductsBLL 클래스를 사용 하는 ObjectDataSource](batch-updating-cs/_static/image2.gif)](batch-updating-cs/_static/image3.png)

**그림 2**: ObjectDataSource를 사용 하 여 구성 합니다 `ProductsBLL` 클래스 ([큰 이미지를 보려면 클릭](batch-updating-cs/_static/image4.png))


[![Retrieve GetProducts 메서드를 사용 하 여 제품 데이터](batch-updating-cs/_static/image3.gif)](batch-updating-cs/_static/image5.png)
...
[![SUPDATE, INSERT 및 DELETE 탭 (없음)에 있는 드롭다운 목록은 et](batch-updating-cs/_static/image4.gif)](batch-updating-cs/_static/image7.png)
...
[![T그 ProductName TemplateField 이제 텍스트 상자 및 RequiredFieldValidator](batch-updating-cs/_static/image6.gif)](batch-updating-cs/_static/image9.png)
...
[![Add는 CompareValidator 가격 입력 했는지 확인 하는 음수가 아닌 통화 값](batch-updating-cs/_static/image7.gif)](batch-updating-cs/_static/image11.png)
...
[![Configure CategoriesBLL 클래스를 사용 하는 ObjectDataSource](batch-updating-cs/_static/image8.gif)](batch-updating-cs/_static/image13.png)

**그림 8**: ObjectDataSource를 사용 하 여 구성 합니다 `CategoriesBLL` 클래스 ([큰 이미지를 보려면 클릭](batch-updating-cs/_static/image14.png))


[![Retrieve GetCategories 메서드를 사용 하 여 범주 데이터](batch-updating-cs/_static/image9.gif)](batch-updating-cs/_static/image15.png)
...
[![SUPDATE 및 DELETE 탭 (없음)을 드롭 다운 목록 et](batch-updating-cs/_static/image10.gif)](batch-updating-cs/_static/image17.png)
...
[![BDropDownList CategoriesDataSource 찾기](batch-updating-cs/_static/image11.gif)](batch-updating-cs/_static/image19.png)
...
[![E대 한 ach GridView 행은 편집 가능](batch-updating-cs/_static/image13.gif)](batch-updating-cs/_static/image21.png)
...
[![T그 페이지 이제 포함 두 업데이트 제품 단추](batch-updating-cs/_static/image16.gif)](batch-updating-cs/_static/image23.png)
