...
[![E종료는 주 해당 포함 조인 쿼리](updating-the-tableadapter-to-use-joins-vb/_static/image2.png)](updating-the-tableadapter-to-use-joins-vb/_static/image1.png)

**그림 1**: 포함 된 기본 쿼리를 입력 `JOIN` s ([큰 이미지를 보려면 클릭](updating-the-tableadapter-to-use-joins-vb/_static/image3.png))
...
[![T그 InsertCommand, UpdateCommand, 및 DeleteCommand 속성 (없음)으로 설정 됩니다](updating-the-tableadapter-to-use-joins-vb/_static/image7.png)](updating-the-tableadapter-to-use-joins-vb/_static/image6.png)

**그림 4**: 합니다 `InsertCommand`, `UpdateCommand`, 및 `DeleteCommand` 속성 (없음)으로 설정 됩니다 ([클릭 하 여 큰 이미지 보기](updating-the-tableadapter-to-use-joins-vb/_static/image8.png))
...
## <a name="step-1-creating-the-tableadapter-using-a-simplified-main-query"></a>1단계: 간소화 된 기본 쿼리를 사용 하는 TableAdapter 만들기
...
[![S새 저장된 프로시저 만들기 옵션을 선택](updating-the-tableadapter-to-use-joins-vb/_static/image10.png)](updating-the-tableadapter-to-use-joins-vb/_static/image9.png)

**그림 5**: 새 저장 프로시저 옵션 선택 만들기 ([클릭 하 여 큰 이미지 보기](updating-the-tableadapter-to-use-joins-vb/_static/image11.png))
...
[![N저장 프로시저를 TableAdapter s \ 이름](updating-the-tableadapter-to-use-joins-vb/_static/image13.png)](updating-the-tableadapter-to-use-joins-vb/_static/image12.png)

**그림 6**: TableAdapter가 저장 프로시저 이름 ([클릭 하 여 큰 이미지 보기](updating-the-tableadapter-to-use-joins-vb/_static/image14.png))
...
[![N이름 () 메서드를 채울 tableadapter 및 GetEmployees](updating-the-tableadapter-to-use-joins-vb/_static/image16.png)](updating-the-tableadapter-to-use-joins-vb/_static/image15.png)
...
[![T그 TableAdapter 포함 삽입, 업데이트 및 삭제 기능](updating-the-tableadapter-to-use-joins-vb/_static/image19.png)](updating-the-tableadapter-to-use-joins-vb/_static/image18.png)

**그림 8**: TableAdapter 포함 삽입, 업데이트 및 삭제 기능 ([클릭 하 여 큰 이미지 보기](updating-the-tableadapter-to-use-joins-vb/_static/image20.png))
...
## <a name="step-2-customizing-the-stored-procedure-to-include-ajoin"></a>2단계: 포함 하도록 저장된 프로시저를 사용자 지정을`JOIN`
...
[![T그 저장 프로시저 결과 출력 창에 표시 됩니다](updating-the-tableadapter-to-use-joins-vb/_static/image22.png)](updating-the-tableadapter-to-use-joins-vb/_static/image21.png)

**그림 9**: 저장 프로시저 결과 출력 창에 표시 됩니다 ([클릭 하 여 큰 이미지 보기](updating-the-tableadapter-to-use-joins-vb/_static/image23.png))


## <a name="step-3-updating-the-datatable-s-columns"></a>3단계: DataTable의 열 업데이트
...
[![T그 마법사 Employees_Select 저장 프로시저에 대 한 업데이트 된 열 목록을 보여 줍니다](updating-the-tableadapter-to-use-joins-vb/_static/image25.png)](updating-the-tableadapter-to-use-joins-vb/_static/image24.png)

**그림 10**: 마법사의 열 업데이트 목록을 표시 합니다 `Employees_Select` 저장 프로시저 ([큰 이미지를 보려면 클릭](updating-the-tableadapter-to-use-joins-vb/_static/image26.png))


마침을 클릭 하 여 마법사를 완료 합니다. 데이터 집합 디자이너로 돌아가면 합니다 `EmployeesDataTable` 두 개의 추가 열이 포함 됩니다: `ManagerFirstName` 및 `ManagerLastName`합니다.


[![T그 EmployeesDataTable 포함 새 열 두 개](updating-the-tableadapter-to-use-joins-vb/_static/image28.png)](updating-the-tableadapter-to-use-joins-vb/_static/image27.png)

**그림 11**: 합니다 `EmployeesDataTable` 새 열 두 개 포함 되어 있습니다 ([큰 이미지를 보려면 클릭](updating-the-tableadapter-to-use-joins-vb/_static/image29.png))
...
## <a name="step-4-implementing-the-business-logic-layer"></a>4단계: 비즈니스 논리 레이어 구현
...
## <a name="step-5-working-with-the-data-in-the-presentation-layer"></a>5단계: 프레젠테이션 계층에서 데이터 작업
...
[![Configure EmployeesBLLWithSprocs 클래스를 사용 하는 ObjectDataSource](updating-the-tableadapter-to-use-joins-vb/_static/image31.png)](updating-the-tableadapter-to-use-joins-vb/_static/image30.png)

**그림 12**: ObjectDataSource를 사용 하 여 구성 합니다 `EmployeesBLLWithSprocs` 클래스 ([큰 이미지를 보려면 클릭](updating-the-tableadapter-to-use-joins-vb/_static/image32.png))


[![HObjectDataSource ave 메서드 종료 되 고 GetEmployees 사용](updating-the-tableadapter-to-use-joins-vb/_static/image34.png)](updating-the-tableadapter-to-use-joins-vb/_static/image33.png)
...
[![T그 조인 Employees_Select 저장 프로시저에서 반환 이름이 관리자](updating-the-tableadapter-to-use-joins-vb/_static/image37.png)](updating-the-tableadapter-to-use-joins-vb/_static/image36.png)

**그림 14**: 합니다 `JOIN` 에 `Employees_Select` 저장 프로시저의의 이름이 관리자를 반환 합니다. ([전체 크기 이미지를 보려면 클릭](updating-the-tableadapter-to-use-joins-vb/_static/image38.png))
...
[![D외래 키 제약 조건 위반을에서 해당 주문 결과 포함 하는 직원 eleting](updating-the-tableadapter-to-use-joins-vb/_static/image40.png)](updating-the-tableadapter-to-use-joins-vb/_static/image39.png)

**그림 15**: 외래 키 제약 조건 위반을 해당 주문을 결과 있는 직원을 삭제 ([클릭 하 여 큰 이미지 보기](updating-the-tableadapter-to-use-joins-vb/_static/image41.png))
