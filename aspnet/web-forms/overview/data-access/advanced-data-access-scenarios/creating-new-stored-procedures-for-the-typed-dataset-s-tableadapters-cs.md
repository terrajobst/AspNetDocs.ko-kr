...
**그림 5**: 새 저장 프로시저 만들기 TableAdpater 지시 ([클릭 하 여 큰 이미지 보기](creating-new-stored-procedures-for-the-typed-dataset-s-tableadapters-cs/_static/image11.png))
