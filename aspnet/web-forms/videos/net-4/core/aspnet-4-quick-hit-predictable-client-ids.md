...
---
# <a name="aspnet-4-quick-hit---predictable-client-ids"></a>ASP.NET 4 "빠른 적중"-예측 가능한 클라이언트 Id

만든 사람 [Stagner](https://github.com/JoeStagner)

이 비디오에서는 컨트롤에 대 한 클라이언트 ID가 생성 되는 방법을 보다 정확 하 게 지정할 수 있는 ClientIDMode 속성에 대해 알아봅니다. 

[&#9654;비디오 보기 (10 분)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-predictable-client-ids)
