...
---
# <a name="aspnet-4-quick-hit---ajax-data-templates"></a>ASP.NET 4 "빠른 적중"-AJAX 데이터 템플릿

만든 사람 [Stagner](https://github.com/JoeStagner)

이 비디오에서는 클라이언트 템플릿을 사용 하 여 DataView 컨트롤과 함께 데이터베이스 레코드를 표시 하는 방법에 대해 설명 합니다. 

[&#9654;비디오 보기 (12 분)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-4-quick-hit-ajax-data-templates)
