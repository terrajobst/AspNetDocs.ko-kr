...
> 이러한 비디오에서는 간단한 ASP.NET 응용 프로그램에 대해 형식화 된 데이터 집합을 사용 하 여 데이터 액세스 계층을 만드는 방법을 보여 줍니다.

- [ASP.NET 애플리케이션의 데이터 액세스 레이어](data-access-layers-in-aspnet-applications.md)
