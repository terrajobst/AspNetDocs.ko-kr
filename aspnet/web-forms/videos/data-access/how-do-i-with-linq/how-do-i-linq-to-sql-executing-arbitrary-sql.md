...
이 비디오에서는 ExecuteCommand 구문을 통해 임의의 SQL을 실행 하 고 부분 DataContext 클래스를 통해 코드를 캡슐화 하는 방법을 보여 줍니다.

[&#9654;비디오 보기 (4 분)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-linq-to-sql-executing-arbitrary-sql)
