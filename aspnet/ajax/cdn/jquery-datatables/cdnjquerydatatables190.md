...
---
# <a name="jquery-datatables-190"></a><span data-ttu-id="cb986-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="cb986-102">jQuery DataTables 1.9.0</span></span>

<span data-ttu-id="cb986-103">JQuery Datatable 플러그 인에 대 한 다음 파일은 CDN에서 호스팅됩니다.</span><span class="sxs-lookup"><span data-stu-id="cb986-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
