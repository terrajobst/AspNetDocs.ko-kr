...
자세한 내용은 [방법: 모델 데이터를 사용 하 여 DataAnnotations 특성의 유효성을 검사](https://go.microsoft.com/fwlink/?LinkId=159063) MSDN 웹 사이트입니다. 이러한 특성의 사용법을 보여 주는 샘플 프로젝트는에서 다운로드할 수 있습니다 [ https://go.microsoft.com/fwlink/?LinkId=157753 ](https://go.microsoft.com/fwlink/?LinkId=157753)합니다.
