...
합니다 *ViewStateMode* 속성을 사용 하는 열거형 값입니다. *사용 하도록 설정*, *사용 안 함*, 및 *상속*합니다. *사용 하도록 설정* 로 설정 된 모든 자식 컨트롤에 대 한 상태로 해당 컨트롤의 뷰 *상속* 이거나는 아무 것도 설정 합니다. *사용 안 함* 뷰 상태를 사용 하지 않도록 설정 및 *상속* 컨트롤을 사용 하도록 지정 합니다 *ViewStateMode* 부모 컨트롤에서 설정 합니다.
...
예를 들어 &lt;%: 요청 ["/userinput&gt"] %&gt; 의 값에 HTML 인코딩합니다 *["/userinput&gt"] 요청*합니다.
