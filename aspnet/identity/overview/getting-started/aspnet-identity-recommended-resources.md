...
- [ASP.NET Id를 사용 하 여 통합 문제를 Google OpenId](http://blog.technovert.com/2014/01/google-openid-integration-issues-asp-net-identity/) 오류가 발생 하는 경우: 요청 필터링 모듈을 찾이 없습니다 HTTP 오류 404.15-쿼리 문자열이 너무 길어 요청을 거부 하도록 구성 된
- [WSAT는 대신 Thinktecture.IdentityManager](http://www.hanselman.com/blog/ThinktectureIdentityManagerAsAReplacementForTheASPNETWebSiteAdministrationTool.aspx)
- [ASP.NET Web API 2, Owin을 및 Id를 사용 하 여 AngularJS 토큰 인증](http://bitoftech.net/2014/06/09/angularjs-token-authentication-using-asp-net-web-api-2-owin-asp-net-identity/)
...
- **Q**: 모든 요청에 대 한 불필요 한 데이터베이스 쿼리를 방지 하려면 ASP.NET Id 쿠키에 사용자의 실제 이름과 같은 사용자 지정 클레임을 어떻게 저장할 수 있습니다. 답변 [여기](http://stackoverflow.com/questions/23622047/identity-cookie-loses-custom-claim-information-after-a-period-of-time)합니다.
- **Q: AspNetUser 암호 해시를 업데이트 하는 중**: 프로젝트 2가 있습니다. 관리 측면에는 Windows 인증을 사용 하 여 다른을 ASP.NET 인증을 사용 하는 그 중 하나입니다. 관리 프로젝트를 다른 사용자를 관리할 수 있게 되기를 원합니다. 암호를 제외한 모든 것을 수정할 수 있습니다. [여기에 답변](http://stackoverflow.com/questions/23880666/updating-aspnetuser-password-hash)합니다.
- **Q**: 다른 사용자에 대 한 관리자 암호를 재설정할 수는 방법 답변 [여기](http://stackoverflow.com/questions/23783249/identity-2-0-reset-password-by-admin/24211766#24211766)합니다.
...
- **Q**: 외부 인증 공급자를 사용 하는 경우 기억 합니다. 답변 [여기](http://stackoverflow.com/questions/23180896/how-to-remember-the-login-in-mvc5-when-an-external-provider-is-used)합니다.
- **Q**: 필요한 이유는 않는 모든 요청을 ApplicationDBContext 하지 않습니다. 오버 헤드가 너무 큽니다. 응답, 아니요, 오버 헤드가 낮습니다.
- Q: 로그인된 된 사용자의 목록 가져오기 답변 [여기](http://stackoverflow.com/questions/22995653/getting-a-list-of-logged-in-users-in-asp-net-identity/)합니다.
- Q: 사용자 Microsoft.AspNet.Identity 로그인 할 때를 감지할 수 있습니다 하는 방법 답변 [여기](http://stackoverflow.com/questions/22956486/how-can-i-detect-when-a-user-logs-in-with-microsoft-aspnet-identity/22970698#22970698)합니다.
- Q: Id에 대 한 지역화 된 오류 메시지 가져오기 답변 [여기](http://stackoverflow.com/questions/22835981/asp-net-identity-localization-publickeytoken/22845864#22845864)합니다.
- Q: 30 분 마다 새 클레임을 가져오려는 CookieMiddleware를 구성 하려면 어떻게 해야 하나요? 답변 [여기](http://stackoverflow.com/questions/22682663/how-to-hold-the-cookies-claims-updated-with-mcv5-owin/22796932#22796932)합니다.
- Q: 수정 어떻게 해야 합니까 사용자에 대 한 클레임은 로그인 후? 답변 [여기](http://stackoverflow.com/questions/22768836/can-i-modify-claims-in-asp-net-identity-with-owin-after-calling-signin/22769963#22769963)합니다.
