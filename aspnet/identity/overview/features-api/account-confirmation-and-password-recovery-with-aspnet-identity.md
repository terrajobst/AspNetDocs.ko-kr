...
title: 계정 확인 및 암호 복구-ASP.NET Id (C#)-ASP.NET 4.x
author: HaoK
...
- [ASP.NET Identity에 대한 사용자 지정 스토리지 공급자 개요](../extensibility/overview-of-custom-storage-providers-for-aspnet-identity.md)
