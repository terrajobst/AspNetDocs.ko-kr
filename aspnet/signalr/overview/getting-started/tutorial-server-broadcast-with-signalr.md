...
1. <span data-ttu-id="1b0fc-159">클래스의 이름을 *StockTickerHub* 하 고 프로젝트에 추가 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-159">Name the class *StockTickerHub* and add it to the project.</span></span>
    ...
    <span data-ttu-id="1b0fc-160">이 단계에서는 합니다 *StockTickerHub.cs* 클래스 파일입니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-160">This step creates the *StockTickerHub.cs* class file.</span></span> <span data-ttu-id="1b0fc-161">동시에 프로젝트에 SignalR을 지 원하는 스크립트 파일 및 어셈블리 참조의 집합을 추가 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-161">Simultaneously, it adds a set of script files and assembly references that supports SignalR to the project.</span></span>
...
#### <a name="create-stocktickercs"></a><span data-ttu-id="1b0fc-175">StockTicker.cs 만들기</span><span class="sxs-lookup"><span data-stu-id="1b0fc-175">Create StockTicker.cs</span></span>
...
<span data-ttu-id="1b0fc-203">`_updatingStockPrices` 지정 된 플래그 [volatile](https://msdn.microsoft.com/library/x13ttww7.aspx) 는 스레드로부터 안전 해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-203">The `_updatingStockPrices` flag designated [volatile](https://msdn.microsoft.com/library/x13ttww7.aspx) to make sure it is thread-safe.</span></span>
...
<span data-ttu-id="1b0fc-233">HTML 페이지에 데이터가 표시 됩니다 및 JavaScript 파일에서 데이터를 구성 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-233">The HTML page will display the data and the JavaScript file will organize the data.</span></span>
...
1. <span data-ttu-id="1b0fc-251">**솔루션 탐색기**를 확장 하 고 **스크립트**합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-251">In **Solution Explorer**, expand **Scripts**.</span></span>
...
#### <a name="getting-updated-stock-prices"></a><span data-ttu-id="1b0fc-280">업데이트 된 주식 시세 가져오기</span><span class="sxs-lookup"><span data-stu-id="1b0fc-280">Getting updated stock prices</span></span>
...
1. <span data-ttu-id="1b0fc-309">**F5** 키를 눌러 프로젝트를 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-309">Press **F5** to run the project.</span></span>
...
### <a name="install-the-signalrsample-nuget-package"></a><span data-ttu-id="1b0fc-323">SignalR.Sample NuGet 패키지를 설치 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-323">Install the SignalR.Sample NuGet package</span></span>
...
1. <span data-ttu-id="1b0fc-336">**F5** 키를 눌러 앱을 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-336">Press **F5** to run the app.</span></span>
     ...
     <span data-ttu-id="1b0fc-337">처음으로 앱을 실행 하는 경우 "시장"는 "closed" 및 정적 테이블 및 되지 스크롤 하는 주식 종목 창을 표시 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-337">When you run the app for the first time, the "market" is "closed" and you see a static table and a ticker window that isn't scrolling.</span></span>
...
### <a name="live-stock-ticker-display"></a><span data-ttu-id="1b0fc-353">실시간 주식 시세 표시기 표시</span><span class="sxs-lookup"><span data-stu-id="1b0fc-353">Live Stock Ticker display</span></span>
...
#### <a name="signalrsample-stocktickerhubcs"></a><span data-ttu-id="1b0fc-365">SignalR.Sample StockTickerHub.cs</span><span class="sxs-lookup"><span data-stu-id="1b0fc-365">SignalR.Sample StockTickerHub.cs</span></span>
...
<span data-ttu-id="1b0fc-376">합니다 `updateStockPrice` 함수는 이제 주식 종목 표시와 테이블을 모두 처리 하 고 사용 하 여 `jQuery.Color` 빨간색 및 녹색 깜빡입니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-376">The `updateStockPrice` function now handles both the table and the ticker display, and it uses `jQuery.Color` to flash red and green colors.</span></span>

<span data-ttu-id="1b0fc-377">새 함수 *SignalR.StockTicker.js* 사용 하도록 설정 하 고 시장 상태에 따라 단추를 사용 하지 않도록 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-377">New functions in *SignalR.StockTicker.js* enable and disable the buttons based on market state.</span></span> <span data-ttu-id="1b0fc-378">이러한도 중지 하거나 시작 합니다 **실시간 주식 시세 표시기** 가로 스크롤.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-378">They also stop or start the **Live Stock Ticker** horizontal scrolling.</span></span> <span data-ttu-id="1b0fc-379">다양 한 함수에 추가 되는 때문 `ticker.client`, 앱에서는 합니다 [함수를 확장 하는 jQuery](http://api.jquery.com/jQuery.extend/) 추가할.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-379">Since many functions are being added to `ticker.client`, the app uses the [jQuery extend function](http://api.jquery.com/jQuery.extend/) to add them.</span></span>

[!code-javascript[Main](tutorial-server-broadcast-with-signalr/samples/sample28.js)]

### <a name="additional-client-setup-after-establishing-the-connection"></a><span data-ttu-id="1b0fc-380">연결을 설정한 후 추가 클라이언트 설정</span><span class="sxs-lookup"><span data-stu-id="1b0fc-380">Additional client setup after establishing the connection</span></span>

<span data-ttu-id="1b0fc-381">클라이언트 연결을 설정, 후 일부 추가 작업을 수행에 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-381">After the client establishes the connection, it has some additional work to do:</span></span>

* <span data-ttu-id="1b0fc-382">시장 열림 또는 닫힘 적절 한 호출 하는 경우 찾기 `marketOpened` 또는 `marketClosed` 함수입니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-382">Find out if the market is open or closed to call the appropriate `marketOpened` or `marketClosed` function.</span></span>

* <span data-ttu-id="1b0fc-383">단추에 대 한 server 메서드 호출을 연결 합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-383">Attach the server method calls to the buttons.</span></span>

[!code-javascript[Main](tutorial-server-broadcast-with-signalr/samples/sample29.js)]

<span data-ttu-id="1b0fc-384">서버 메서드 앱 연결을 설정 후까지 단추 연결 되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-384">The server methods aren't wired up to the buttons until after the app establishes the connection.</span></span> <span data-ttu-id="1b0fc-385">이므로 제공 되기 전에 코드는 서버 메서드를 호출할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-385">It's so the code can't call the server methods before they're available.</span></span>

## <a name="additional-resources"></a><span data-ttu-id="1b0fc-386">추가 자료</span><span class="sxs-lookup"><span data-stu-id="1b0fc-386">Additional resources</span></span>

<span data-ttu-id="1b0fc-387">이 자습서에서는 연결 된 모든 클라이언트에 게 서버에서 메시지를 브로드캐스트하는 SignalR 응용 프로그램을 프로그래밍 하는 방법을 알아보았습니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-387">In this tutorial you've learned how to program a SignalR application that broadcasts messages from the server to all connected clients.</span></span> <span data-ttu-id="1b0fc-388">이제 모든 클라이언트에서 알림 응답에서 메시지를 정기적으로 브로드캐스트할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-388">Now you can broadcast messages on a periodic basis and in response to notifications from any client.</span></span> <span data-ttu-id="1b0fc-389">다중 스레드 singleton 인스턴스 개념이 멀티 플레이어 온라인 게임 시나리오에서 서버 상태를 유지 하기 위해 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-389">You can use the concept of multi-threaded singleton instance to maintain server state in multi-player online game scenarios.</span></span> <span data-ttu-id="1b0fc-390">예를 들어 참조 [SignalR을 기반으로 ShootR 게임](https://github.com/NTaylorMullen/ShootR)합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-390">For an example, see [the ShootR game based on SignalR](https://github.com/NTaylorMullen/ShootR).</span></span>

<span data-ttu-id="1b0fc-391">피어-투-피어 통신 시나리오를 보여 주는 자습서를 참조 하세요. [Getting Started with SignalR](introduction-to-signalr.md) 하 고 [SignalR을 사용 하 여 실시간 업데이트](tutorial-high-frequency-realtime-with-signalr.md)합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-391">For tutorials that show peer-to-peer communication scenarios, see [Getting Started with SignalR](introduction-to-signalr.md) and [Real-Time Updating with SignalR](tutorial-high-frequency-realtime-with-signalr.md).</span></span>

<span data-ttu-id="1b0fc-392">SignalR에 대 한 자세한 내용은 다음 리소스를 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-392">For more about SignalR, see the following resources:</span></span>

* [<span data-ttu-id="1b0fc-393">ASP.NET SignalR</span><span class="sxs-lookup"><span data-stu-id="1b0fc-393">ASP.NET SignalR</span></span>](../../index.md)
* [<span data-ttu-id="1b0fc-394">SignalR 프로젝트</span><span class="sxs-lookup"><span data-stu-id="1b0fc-394">SignalR Project</span></span>](http://signalr.net/)
* [<span data-ttu-id="1b0fc-395">SignalR GitHub 및 샘플</span><span class="sxs-lookup"><span data-stu-id="1b0fc-395">SignalR GitHub and Samples</span></span>](https://github.com/SignalR/SignalR)
* [<span data-ttu-id="1b0fc-396">SignalR Wiki</span><span class="sxs-lookup"><span data-stu-id="1b0fc-396">SignalR Wiki</span></span>](https://github.com/SignalR/SignalR/wiki)

## <a name="next-steps"></a><span data-ttu-id="1b0fc-397">다음 단계</span><span class="sxs-lookup"><span data-stu-id="1b0fc-397">Next steps</span></span>

<span data-ttu-id="1b0fc-398">이 자습서에서는 다음을 수행했습니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-398">In this tutorial, you:</span></span>

> [!div class="checklist"]
> * <span data-ttu-id="1b0fc-399">프로젝트를 생성합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-399">Created the project</span></span>
> * <span data-ttu-id="1b0fc-400">서버 코드 설정</span><span class="sxs-lookup"><span data-stu-id="1b0fc-400">Set up the server code</span></span>
> * <span data-ttu-id="1b0fc-401">서버 코드를 검사합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-401">Examined the server code</span></span>
> * <span data-ttu-id="1b0fc-402">클라이언트 코드를 설정 하기</span><span class="sxs-lookup"><span data-stu-id="1b0fc-402">Set up the client code</span></span>
> * <span data-ttu-id="1b0fc-403">클라이언트 코드를 검사합니다.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-403">Examined the client code</span></span>
> * <span data-ttu-id="1b0fc-404">응용 프로그램 테스트</span><span class="sxs-lookup"><span data-stu-id="1b0fc-404">Tested the application</span></span>
> * <span data-ttu-id="1b0fc-405">활성화 된 로깅</span><span class="sxs-lookup"><span data-stu-id="1b0fc-405">Enabled logging</span></span>

<span data-ttu-id="1b0fc-406">ASP.NET SignalR 2를 사용 하 여 실시간 웹 응용 프로그램을 만드는 방법에 알아보려면 다음 문서로 계속 진행 하세요.</span><span class="sxs-lookup"><span data-stu-id="1b0fc-406">Advance to the next article to learn how to create a real-time web application that uses ASP.NET SignalR 2.</span></span>
> [!div class="nextstepaction"]
> [<span data-ttu-id="1b0fc-407">SignalR을 사용 하 여 실시간 웹 앱 만들기</span><span class="sxs-lookup"><span data-stu-id="1b0fc-407">Create real-time web app with SignalR</span></span>](real-time-web-applications-with-signalr.md)
