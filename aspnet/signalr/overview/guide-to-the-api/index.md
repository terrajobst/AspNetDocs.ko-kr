...
title: API에 대 한 SignalR 가이드 | Microsoft Docs
author: bradygaster
description: SignalR Hubs API를 사용 하는 방법에 대 한 설명서입니다. 권한 부여 API는 보안 탭을 참조 하세요.
ms.author: bradyg
ms.date: 09/19/2014
...
ms.locfileid: "78431555"
---
# <a name="signalr-guide-to-the-api"></a>API에 대 한 SignalR 가이드

> SignalR Hubs API를 사용 하는 방법에 대 한 설명서입니다. 권한 부여 API는 보안 탭을 참조 하세요.
