...
다음 코드와 **AuthenticateAsync** 메서드에서 [기본 인증](http://aspnet.codeplex.com/sourcecontrol/latest#Samples/WebApi/BasicAuthentication/ReadMe.txt) 샘플입니다. 주석은 각 단계를 나타냅니다. 코드는 여러 유형의 오류를 보여줍니다. 없는 자격 증명, 잘못 된 자격 증명 및 잘못 된 사용자 이름/암호를 사용 하 여 권한 부여 헤더입니다.
...
참고: 기본 인증 예제 확장 메서드를 배치 하 여이 논리를 약간 추상화 합니다.
