...
## <a name="example-rating-a-product"></a>예제: 제품 등급
...
이전 예제에서는 작업을 단일 엔터티에 바인딩되어: 클라이언트는 단일 제품을 평가합니다. 엔터티 컬렉션에 작업을 바인딩할 수 있습니다. 다음 변경 내용을 확인 합니다.
...
여기의이 중요 한 이유: 액션 일시적인 경우에 서버 작업을 사용할 수 있는 경우 클라이언트에 게 알리는 해야 합니다. 엔터티에서 작업에 대 한 링크를 포함 하 여 수행 합니다. 영화 엔터티에 대 한 예는 다음과 같습니다.
