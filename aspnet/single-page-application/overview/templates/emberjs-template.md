...
- 스크립트/app/모델/\*.js 합니다. 모델을 정의합니다.
- 스크립트/app/뷰/\*.js 합니다. 뷰를 정의합니다.
- 스크립트/app/컨트롤러/\*.js 합니다. 컨트롤러를 정의합니다.
- 스크립트/app/경로 Scripts/app/router.js: 경로 정의합니다.
- 템플릿 /\*.hbs: Handlebars 템플릿을 정의합니다.
...
- application.hbs: 응용 프로그램이 시작 될 때 렌더링 되는 기본 템플릿.
