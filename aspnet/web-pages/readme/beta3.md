...
#### <a name="issue-webmatrix-beta-3-is-only-available-on-platforms-that-support-microsoft-net-framework-4"></a>문제: WebMatrix 베타 3은 Microsoft.NET Framework 4를 지 원하는 플랫폼에서 사용할 수 있습니다만
...
#### <a name="new-htmlraw-method-renders-unencoded-markup"></a>새 항목: 인코딩되지 않은 태그를 렌더링 하는 "Html.Raw" 메서드
...
#### <a name="issue-encrypt-property-is-not-recognized"></a>문제: "암호화" 속성이 인식 되지 않습니다.
...
#### <a name="issue-searchfilter-does-not-work-in-reports-for-group-by-issue-type"></a>문제: 검색/필터 그룹에 대 한 보고서에서 작동 하지 않습니다. 문제 유형
