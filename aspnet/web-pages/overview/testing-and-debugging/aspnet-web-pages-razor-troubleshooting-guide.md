...
### <a name="http-error-403---forbidden-access-is-denied"></a>HTTP 오류 403-사용할 수 없음: 액세스가 거부되었습니다.
...
.NET Framework 4를 사용 하도록 올바르게 구성 되지 않은 서버나 있어 나중에 코드를 인식 하지 않습니다 하는 경우이 오류가 발생할 수 있습니다 `@{ }` 블록입니다. 이전에 대 한 설명을 참조 *HTTP 오류 403-사용할 수 없음: 액세스가 거부 되었습니다.* 합니다.
...
- <em>사서함을 사용할 수 없습니다. 서버 응답이 했습니다. 5.1.0 &lt; someuser@invaliddomain &gt; 거부 하는 보낸 사람: 잘못 된 보낸 사람 도메인</em>
