...
4. ASP.NET 및 웹 도구 2012.2 설치 폴더로 이동 합니다.
    ...
    2. Visual Studio 2012 Express for Web에 대 한: **Program Files\Microsoft ASP.NET\ASP.NET Web Stack\Visual Studio Express 2012 for Web**
...
Index.cshtml 파일 blacked 다음 텍스트를 추가 합니다.  
 ...
 &lt;클래스 입력 =&quot;addTodo&quot; 유형 =&quot;텍스트&quot; 데이터를 바인딩 =&quot;값: newTodoTitle, 자리 표시자: '여기에 형식을 추가 하려면', blurOnEnter: true **hasfocus: isSelected**, 이벤트: {흐리게 표시: addTodo}&quot; /&gt;  
 &lt;/form&gt;
