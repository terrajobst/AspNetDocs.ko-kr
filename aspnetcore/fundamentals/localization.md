...
**참고:** 일반적으로 텍스트 및 HTML이 아닌 지역화 하려고 합니다.
...
1. **솔루션 탐색기**에서 리소스 파일을 포함하는 폴더 > **추가** > **새 항목**을 마우스 오른쪽 단추로 차례로 클릭합니다.
    ...
    ![중첩 된 상황에 맞는 메뉴: 솔루션 탐색기 상황에 맞는 메뉴 리소스에 대 한 열려 있습니다. 두 번째 바로 가기 메뉴는 강조 표시된 새 항목 명령을 보여 주는 추가에 대해 열려 있습니다.](localization/_static/newi.png)
...
* 세계화 (G11N): 다른 언어 및 지역을 지원 앱을 만드는 프로세스입니다.
* 지역화 (l10n): 지정 된 언어 및 지역에 대 한 앱을 사용자 지정 하는 프로세스입니다.
* 국제화 (I18N): 세계화 및 지역화 모두에 대해 설명합니다.
* 문화권: 언어 및 필요에 따라 지역 이며
* 중립 문화권: 지정된 된 언어로 있지만 지역이 없는 culture입니다. (예: "en", "es")
* 특정 문화권의 경우: 문화권에는 지정한 언어 및 지역입니다. (예: "en-US", "en-GB", "es-CL")
* 부모 문화권: 특정 문화권을 포함 하는 중립 문화권입니다. (예: "en"은 "en-US" 및 "en-GB"의 부모 문화권)
* 로캘: 로캘 culture와 같습니다.
