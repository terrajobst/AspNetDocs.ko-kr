...
<span data-ttu-id="95c1f-111">대부분의 웹 앱을 명시적으로 Razor SDK를 참조할 필요가 없습니다.</span><span class="sxs-lookup"><span data-stu-id="95c1f-111">Most web apps aren't required to explicitly reference the Razor SDK.</span></span>
